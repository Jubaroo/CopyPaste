...
public class FiftyCopyItemPerformer implements ActionPerformer {
    private static Logger logger = Logger.getLogger(FiftyCopyItemPerformer.class.getName());
    private final short actionId;
    public final ActionEntry actionEntry;

    public FiftyCopyItemPerformer() {
        actionId = (short) ModActions.getNextActionId();
        actionEntry = ActionEntry.createEntry(actionId, "50 Copies", "copying", new int[]{
