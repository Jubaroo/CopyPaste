...
public class FiveCopyItemPerformer implements ActionPerformer {
    private static Logger logger = Logger.getLogger(FiveCopyItemPerformer.class.getName());
    private final short actionId;
    public final ActionEntry actionEntry;

    public FiveCopyItemPerformer() {
        actionId = (short) ModActions.getNextActionId();
        actionEntry = ActionEntry.createEntry(actionId, "5 Copies", "copying", new int[]{
