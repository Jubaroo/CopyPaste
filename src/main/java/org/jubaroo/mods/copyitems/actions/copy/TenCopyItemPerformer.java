...
public class TenCopyItemPerformer implements ActionPerformer {
    private static Logger logger = Logger.getLogger(TenCopyItemPerformer.class.getName());
    private final short actionId;
    public final ActionEntry actionEntry;

    public TenCopyItemPerformer() {
        actionId = (short) ModActions.getNextActionId();
        actionEntry = ActionEntry.createEntry(actionId, "10 Copies", "copying", new int[]{
