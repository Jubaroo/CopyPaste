...
public class TwentyCopyItemPerformer implements ActionPerformer {
    private static Logger logger = Logger.getLogger(TwentyCopyItemPerformer.class.getName());
    private final short actionId;
    public final ActionEntry actionEntry;

    public TwentyCopyItemPerformer() {
        actionId = (short) ModActions.getNextActionId();
        actionEntry = ActionEntry.createEntry(actionId, "20 Copies", "copying", new int[]{
